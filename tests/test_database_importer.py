...
def test_import_from_json_full_hierarchy(session):
    hierarchy = json.dumps(
        {
            ...
            "facts": {
                "d852834bff4f40329e83c46cb9989863": {
                    "format": "text",
                    "value": "question",
                },
                "d852834bff4f40329e83c46cb9989864": {
                    "format": "text",
                    "value": "answer",
                },
            },
    ...
    import_from_json(session=session, json_string=hierarchy, stop_on_error=True)
